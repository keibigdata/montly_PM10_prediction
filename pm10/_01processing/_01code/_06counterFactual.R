...
for (i in 1:length(varVec)){
  ...
  gbm1.cf.ex3.y0hat <- predict(gbm1.ex3, newdata=cf.newdata.ex3, n.trees=5000, type="response", predict.all = TRUE)
  rf.cf.ex3.y0hat <- predict(rf.ex3, newdata=cf.newdata.ex3, type="response", predict.all = TRUE)
  cf.newdata.ex3[,varVec[i]] <- cf.newdata.ex3[,varVec[i]] * 0.7
  
  cf.newdata.ex4 <- merged.ex4[ind.ex4==2 & !is.na(merged.ex4[,"PM10"]),]
  gbm1.cf.ex4.y0hat <- predict(gbm1.ex4, newdata=cf.newdata.ex4, n.trees=5000, type="response", predict.all = TRUE)
  rf.cf.ex4.y0hat <- predict(rf.ex4, newdata=cf.newdata.ex4, type="response", predict.all = TRUE)
  cf.newdata.ex4[,varVec[i]] <- cf.newdata.ex4[,varVec[i]] * 0.7
  
  cf.newdata.ex5 <- merged.ex5[ind.ex5==2 & !is.na(merged.ex5[,"PM10"]),]
  gbm1.cf.ex5.y0hat <- predict(gbm1.ex5, newdata=cf.newdata.ex5, n.trees=5000, type="response", predict.all = TRUE)
  rf.cf.ex5.y0hat <- predict(rf.ex5, newdata=cf.newdata.ex5, type="response", predict.all = TRUE)
  cf.newdata.ex5[,varVec[i]] <- cf.newdata.ex5[,varVec[i]] * 0.7
  
  cf.newdata.ex6 <- merged.ex6[ind.ex6==2 & !is.na(merged.ex6[,"PM10"]),]
  gbm1.cf.ex6.y0hat <- predict(gbm1.ex6, newdata=cf.newdata.ex6, n.trees=5000, type="response", predict.all = TRUE)
  rf.cf.ex6.y0hat <- predict(rf.ex6, newdata=cf.newdata.ex6, type="response", predict.all = TRUE)
  ...
  diff.gbm.ex3 = mean(gbm1.cf.ex3-gbm1.cf.ex3.y0hat) / mean(gbm1.cf.ex3.y0hat) * 100
  diff.gbm.ex4 = mean(gbm1.cf.ex4-gbm1.cf.ex4.y0hat) / mean(gbm1.cf.ex4.y0hat) * 100
...
write.csv(df.diff, "/Users/kei/Documents/_temp_170921/_05variableImportance/cf.4/df_diff_dec30.csv")
write.csv(df.diff2, "/Users/kei/Documents/_temp_170921/_05variableImportance/cf.4/df_diff2_dec30.csv")
write.csv(df.diff3, "/Users/kei/Documents/_temp_170921/_05variableImportance/cf.4/df_diff3_dec30.csv")
